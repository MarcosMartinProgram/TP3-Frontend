...
const integrantes = [
  { 
    ...
    habilidades: [
      ...
      { nombre: "CSS3", nivel: 80 },
      { nombre: "Node.js", nivel: 88 },
      { nombre: "Express", nivel: 82 },
      { nombre: "MySQL", nivel: 76 },
      { nombre: "PostgreSQL", nivel: 70 }
    ],
  ...
  { 
    ...
    descripcion: "Portfolio personal con diseño minimalista y funcionalidad moderna",
    foto: fotoMariano,
    ciudad: "La Plata, Buenos Aires",    
    edad: 39,       
    habilidades: [
      { nombre: "JavaScript", nivel: 85 },
      { nombre: "HTML", nivel: 88 },
      { nombre: "CSS3", nivel: 82 },
      { nombre: "C#", nivel: 75 },
      { nombre: "JAVA", nivel: 78 }
    ],
  ...
  { 
    ...
    edad: 22, 
    habilidades: [
      { nombre: "Java / Springboot", nivel: 90 },
      { nombre: "Bash", nivel: 75 },
      { nombre: "Python", nivel: 85 }
    ],
  ...
  { 
    path: "cecilia", 
    nombre: "Cecilia F", 
    especialidad: "Atención al detalle",
    ...
    edad: 42,
    habilidades: [
      { nombre: "Atención al detalle", nivel: 92 },
      { nombre: "Autodidacta", nivel: 88 },
      { nombre: "Cantar", nivel: 70 },
      { nombre: "Cocinar", nivel: 78 }
    ],
